...
export const ADD_NEW_BOOK_TO_CATALOG = "ADD_NEW_BOOK_TO_CATALOG"
...
export const defaultCover =
  "https://bookstore-catalog.s3.amazonaws.com/cover.png"
...
export const removeBookFromCatalog = (bookID) => async (dispatch, getState) => {
  const booksInStorage = await RestService('GET', {}, 'bookstore-catalog')
  const currentBookIndex = booksInStorage.findIndex(
...
/**
 * Adding new book to catalog
 * @param {*} bookData
 */
export const addBookToCatalog = (bookData) => async (dispatch) => {
  dispatch({
    type: ADDING_OR_EDITING_BOOK,
    payload: true,
  })
